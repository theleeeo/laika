...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/theleeeo/laika/app/gen/search/v1"
	http "net/http"
	strings "strings"
)
...
func NewSearchServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) SearchServiceClient {
	...
	return &searchServiceClient{
		...
		getCapabilities: connect.NewClient[v1.GetCapabilitiesRequest, v1.GetCapabilitiesResponse](
			...
			connect.WithSchema(searchServiceMethods.ByName("GetCapabilities")),
			connect.WithClientOptions(opts...),
		),
	}
}
...
func (c *searchServiceClient) GetCapabilities(ctx context.Context, req *connect.Request[v1.GetCapabilitiesRequest]) (*connect.Response[v1.GetCapabilitiesResponse], error) {
...
func (UnimplementedSearchServiceHandler) GetCapabilities(context.Context, *connect.Request[v1.GetCapabilitiesRequest]) (*connect.Response[v1.GetCapabilitiesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("search.v1.SearchService.GetCapabilities is not implemented"))
}
